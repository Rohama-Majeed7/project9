(function($) {
    ...
    var uxperRoom = {
        ...
        triggerTotalPrice: function(event = 'update') {
            ...
            var service_price = $wrap.find('.extra-service-detail input[name="service_price[]"]').map(function() {
                return $(this).val();
            }).get();
        ...
        triggerWooCheckout: function() {
            ...
            if ($form.find('input[name="add-to-cart"]').val()) {
                $form.on('click', '.btn-submit', function(e) {
                    ...
                    var service_price = $form.find('.extra-service-detail input[name="service_price[]"]').map(function() {
                        return $(this).val();
                    }).get();
                    var extra_services = [];
